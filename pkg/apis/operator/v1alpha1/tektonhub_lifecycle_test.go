...
func TestTektonHubHappyPath(t *testing.T) {
	...
	apistest.CheckConditionOngoing(th, DbMigrationInstallerSetAvailable, t)
	...
	th.MarkDbMigrationInstallerSetNotAvailable("waiting for Job to complete")
	apistest.CheckConditionFailed(th, DbMigrationInstallerSetAvailable, t)

	// Installer set created for DB
	th.MarkDbMigrationInstallerSetAvailable()
	apistest.CheckConditionSucceeded(th, DbMigrationInstallerSetAvailable, t)
